...
# Problem : Özellikleri belirtildiğinde kişilerin diyabet hastası
# olup olmadıklarını tahmin edebilecek bir makine öğrenmesi modeli
...
# GÖREV 2: FEATURE ENGINEERING
           # Adım 1:  Eksik ve aykırı değerler için gerekli işlemleri yapınız.
                ...
                # değişkenlerde 0 değeri içeren gözlem birimleri eksik değeri
...
# Gerekli Kütüphane ve Fonksiyonlar import edelim.
import numpy as np
import pandas as pd
...
# cat - kategorik değişkenlerimiz
# num - nümerik değişkenlerimiz
# car - kardinal değişkenlerimiz
...
#tek kategorik değişkenimiz --> "Outcome"
...
# Korelasyon, olasılık kuramı ve istatistikte iki rassal değişken arasındaki
# doğrusal ilişkinin yönünü ve gücünü belirtir
...
# Eksik Degerleri ozetleyen tablo
...
#son durumda nümerik değişkenlerin yorumlanması
df.describe().T
