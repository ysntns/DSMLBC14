...
train = pd.read_csv(r"V:\.miuul\.0 casestudy\.6-machine_learning\HousePrice\train.csv")
test = pd.read_csv(r"V:\.miuul\.0 casestudy\.6-machine_learning\HousePrice\test.csv")
